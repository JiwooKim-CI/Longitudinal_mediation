...
grid1[,`:=`(rm2y2 = p_y2_m2 + p_m2_u*p_y2_u + p_m2_m1*p_y1_m1*p_y2_y1 + 
              p_m2_m1*p_m1_u*p_y1_u*p_y2_y1 + p_m2_m1*p_m1_u*p_y2_u + p_m2_u*p_y1_u*p_y2_y1,
            ...
            ry1y2 = p_y2_y1 + p_y1_m1*p_m2_m1*p_y2_m2 + p_y1_u*p_m1_u*p_m2_m1*p_y2_m2 + 
              p_y1_u*p_y2_u + p_y1_u*p_m2_u*p_y2_m2,
...
grid1[,`:=`(change = p_m2_x*(p_gm_m1*p_m2_m1*p_y2_m2*p_gy_y2 +
                               ...
                               p_gm_m2*p_m2_u*p_y2_u*p_gy_y2)/(2-2*(p_m2_m1^2+p_m1_u*p_m2_u)),
            change_2 = p_m2_x*(p_gm_m1*p_m2_m1*p_y2_m2*p_gy_y2 +
                                  ...
                                  p_gm_m2*p_m2_u*p_y1_u*p_gy_y1+
                                  p_gm_m2*p_m2_u*p_y1_u*p_y2_y1*p_gy_y2+
                                  p_gm_m2*p_m2_u*p_y2_u*p_gy_y2)/(1-1*(p_m2_m1^2+p_m1_u*p_m2_u)),
...
table(grid1$bias_ind)
# in this case, 1 means cases when abs(bias_change) is nearly equal or bigger than abs(bias_ancova)
...
# in this case, 1 means cases when abs(bias_change) is definitely bigger than abs(bias_ancova)
...
grid1small1 <- grid1 |> filter(p_m1_u == p_m2_u+p_m1_u*p_m2_m1 &
